...
const Navbar = () => {
    ...
    return (<nav className=" dark:bg-purple-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="link.png" className="h-8" alt="Flowbite Logo" />
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <Link target='_blank' href={"https://github.com/saksham-pahadi"}>
                        ...
                        {open && <button onClick={()=>{ setopen(!open)}} data-collapse-toggle="navbar-sticky" type="button" className=" p-2 w-10 h-10  rounded-lg md:hidden hover:bg-gray-200  dark:text-gray-400 dark:hover:bg-white " aria-controls="navbar-sticky" aria-expanded="false">
                           <div className='relative top-[2px] h-1 -rotate-45 bg-gray-500 rounded-2xl'></div>
                           <div className='relative bottom-[2px] h-1 rotate-45 bg-gray-500 rounded-2xl'></div>
                        </button>}
                    </div>
                    <div className={`items-center justify-between ${open?"":"hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-purple-800 md:dark:bg-purple-900 dark:border-gray-700">
                            ...
                            <li onClick={()=>{ setopen(!open)}}>
                                <Link href="/shorten" className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Shorten</Link>
                            </li>
                            <li onClick={()=>{ setopen(!open)}}>
